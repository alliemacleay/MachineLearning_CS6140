...
class Adaboost(object):
    ...
    def print_stats(self):
        for round_number in self.errors.keys():
            ...
            print 'testing error: {} total weighted err: {}\nweight distr {}'.format(self.errors[round_number],
                                                                                     self.total_weighted_errors[round_number],
                                                                                     self.weight_distribution[round_number])
...
class BoostRound():
    ...
    def run(self, data, weights):
        ...
        self.error = self.get_error(self.err_matrix)
